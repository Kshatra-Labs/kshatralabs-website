  ...
  return (
    <section className="relative flex h-full w-full items-center justify-center bg-black">
      ...
      <div
        ...
        className="size-45 cursor-pointer"
      >
        <motion.div
          style={{ x, y, opacity }}
  ...
  return (
    <div className="fixed left-0 top-0 z-[101] flex h-screen w-screen items-center justify-center">
      ...
      <motion.div
        ...
        className="relative aspect-video max-w-7xl w-[90vw]"
      >
        <VideoPlayer style={{ width: "100%", height: "100%" }}>
          ...
          <span
            onClick={() => setShowVideoPopOver(false)}
            className="absolute right-4 top-4 z-10 cursor-pointer rounded-full p-2 bg-black/60 hover:bg-black transition-colors"
          >
