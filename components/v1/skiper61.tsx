...
const SimpleMouseFollow = () => {
  ...
  return (
    <div
      ...
      className="relative rounded-4xl bg-neutral-900/40 border border-neutral-800 mt-20 size-[500px] cursor-none overflow-hidden"
    >
      <motion.div
        style={{
          x,
        ...
        className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 pointer-events-none rounded-full size-5 bg-white"
      ></motion.div>
    </div>
  );
};
...
const SpringMouseFollow = () => {
  ...
  return (
    <div
      ...
      className="relative rounded-4xl bg-neutral-900/40 border border-neutral-800 mt-20 size-[500px] overflow-hidden"
    >
      <motion.div
        style={{
          x: xSpring,
        ...
        className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 pointer-events-none rounded-full size-10 bg-orange-500"
      ></motion.div>
    </div>
  );
};
