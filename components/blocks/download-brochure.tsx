          ...
          <section className="py-24 border-t border-b border-neutral-800 bg-[#000000] text-white">
               <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col lg:flex-row lg:items-center justify-between gap-12">
                    <div className="space-y-4 max-w-2xl">
                         <div className="font-mono text-xs uppercase tracking-[0.25em] text-[#cc1414] font-semibold">
                              Technical Documentation
                         </div>
                         <h2 
                              className="text-3xl sm:text-4xl lg:text-5xl font-extrabold uppercase tracking-tight text-white"
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                         <a 
                              ...
                              className="group px-8 py-5 bg-white text-black font-mono text-xs font-bold tracking-[0.2em] uppercase hover:bg-[#cc1414] hover:text-white transition-colors duration-200 flex items-center gap-4"
                         >
