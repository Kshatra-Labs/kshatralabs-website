                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-8 mt-8">
                         ...
                         <div className="lg:col-span-7 lg:col-start-6">
                              ...
                              <div className="flex items-center gap-6 text-[#7aa096]">
                                   <a href="https://www.youtube.com/@KshatraLabs" target="_blank" rel="noopener noreferrer" className="h-8 w-8 transition-colors hover:text-white">
                                   ...
                                   <a href="https://www.instagram.com/kshatralabs" target="_blank" rel="noopener noreferrer" className="h-8 w-8 transition-colors hover:text-white">
                                        <svg width="100%" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="block">
                                   ...
                                   <a href="https://x.com/KshatraLabs" target="_blank" rel="noopener noreferrer" className="h-8 w-8 transition-colors hover:text-white">
                                   ...
                                   <a href="https://in.linkedin.com/company/kshatra-labs" target="_blank" rel="noopener noreferrer" className="h-8 w-8 transition-colors hover:text-white">
                                        <svg width="100%" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="block">
