     ...
     return (
          <footer className="relative z-20 w-full border-t border-[#333] bg-black text-[#eef7f4]">
               ...
               <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
                              ...
                              <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
                                   <div className="sm:col-start-3 shrink-0">
                                        <button
                                             ...
                                             className="flex h-[52px] w-full items-center justify-center bg-[#eef7f4] px-4 font-sans text-[15px] font-bold uppercase tracking-wide text-[#06110f] transition-colors hover:bg-white"
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-8 mt-8">
                                   ...
                                   <div className="flex flex-col gap-4 text-[#eef7f4]">
                                        <div className="flex flex-col gap-4">
                                             <div className="flex items-center gap-2 hidden">
                                                  <div className="max-w-[27ch] font-sans text-[15px] leading-[1.35]">
                                                       <p>
                                        ...
                                        <div className="flex items-center gap-2">
                                             ...
                                             <div className="font-sans text-[15px] leading-[1.35]">
                                                  <p>
                         ...
                         <div className="lg:col-span-7 lg:col-start-6">
                              <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
                                   <div className="flex flex-col gap-4">
                                        <div className="font-sans text-[14px] font-semibold uppercase leading-none tracking-[0.05em] text-[#7aa096]">Products</div>
                                        <ul className="flex flex-col gap-4">
                                             <li>
                                                  <Link href="/products/hawk" className="block font-sans text-[15px] font-medium uppercase leading-[1.2] text-[#eef7f4] transition-colors hover:text-white">
                                                       Hawk Interceptor
                                                  </Link>
                                             </li>
                                             <li>
                                                  <Link href="/products" className="block font-sans text-[15px] font-medium uppercase leading-[1.2] text-[#eef7f4] transition-colors hover:text-white">
                                                       Hawkeye Tracking
                                                  </Link>
                                             </li>
                                             <li>
                                   ...
                                   <div className="flex flex-col gap-4">
                                        <div className="font-sans text-[14px] font-semibold uppercase leading-none tracking-[0.05em] text-[#7aa096]">Company</div>
                                        <ul className="flex flex-col gap-4">
                                             <li>
                                                  <Link href="/about/company" className="block font-sans text-[15px] font-medium uppercase leading-[1.2] text-[#eef7f4] transition-colors hover:text-white">
                                                       About Us
                                                  </Link>
                                             </li>
                                             <li>
                                                  <Link href="/about/team" className="block font-sans text-[15px] font-medium uppercase leading-[1.2] text-[#eef7f4] transition-colors hover:text-white">
                                                       Team
                                                  </Link>
                                             </li>
                                             <li>
                                                  <Link href="/contact-us" onClick={handleContactClick} className="block font-sans text-[15px] font-medium uppercase leading-[1.2] text-[#eef7f4] transition-colors hover:text-white">
                                                       Contact Us
                                                  </Link>
                                             </li>
                                        </ul>
                                   ...
                                   <div className="flex flex-col gap-4">
                                        <div className="font-sans text-[14px] font-semibold uppercase leading-none tracking-[0.05em] text-[#7aa096]">Resources</div>
                                        <ul className="flex flex-col gap-4">
                                             <li>
                                                  <Link href="/careers" className="block font-sans text-[15px] font-medium uppercase leading-[1.2] text-[#eef7f4] transition-colors hover:text-white">
                                                       Careers
                                                  </Link>
                                             </li>
                                             <li>
                                                  <Link href="/terms-of-service" className="block font-sans text-[15px] font-medium uppercase leading-[1.2] text-[#eef7f4] transition-colors hover:text-white">
                                                       Terms of Service
                                                  </Link>
                                             </li>
                                             <li>
                                                  <Link href="/privacy-policy" className="block font-sans text-[15px] font-medium uppercase leading-[1.2] text-[#eef7f4] transition-colors hover:text-white">
                                                       Privacy Policy
                                                  </Link>
                                             </li>
                                        </ul>
                              ...
                              <div className="flex items-center gap-6 text-[#7aa096]">
                                   <a href="https://www.youtube.com/@KshatraLabs" target="_blank" rel="noopener noreferrer" className="h-7 w-7 transition-colors hover:text-white">
                                   ...
                                   <a href="https://www.instagram.com/kshatralabs" target="_blank" rel="noopener noreferrer" className="h-7 w-7 transition-colors hover:text-white">
                                        <svg width="100%" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="block">
                                   ...
                                   <a href="https://www.facebook.com/kshatralabs" target="_blank" rel="noopener noreferrer" className="h-7 w-7 transition-colors hover:text-white">
                                        <svg width="100%" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="block">
                                   ...
                                   <a href="https://x.com/kshatralabs" target="_blank" rel="noopener noreferrer" className="h-7 w-7 transition-colors hover:text-white">
                                   ...
                                   <a href="https://in.linkedin.com/company/kshatra-labs" target="_blank" rel="noopener noreferrer" className="h-7 w-7 transition-colors hover:text-white">
                                        <svg width="100%" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="block">
