          ...
          <div className="relative flex flex-wrap items-center justify-between gap-4 py-3 md:py-4">
            ...
            <div className="flex w-full items-center justify-between lg:w-auto">
              ...
              <Link href="/" className="group">
                <div
                  className="h-5 md:h-6 w-[140px] md:w-[177px] bg-white group-hover:bg-defense-accent transition-colors"
                  style={{
              ...
              >
                {!menuState ? <Menu className="text-white" /> : <X className="text-white" />}
              </button>
            </div>

            {/* Desktop Nav */}
            <div className="hidden lg:block">
              <ul className="flex gap-10 text-sm font-mono uppercase tracking-wide text-neutral-300">
                {menuItems.map((item) => (
                  <li key={item.name}>
