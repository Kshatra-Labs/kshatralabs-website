...
> **Note**: This file (`architechture.md`) is maintained alongside `architecture.md` to ensure absolute compatibility with all AI tools and developer queries regardless of spelling.
